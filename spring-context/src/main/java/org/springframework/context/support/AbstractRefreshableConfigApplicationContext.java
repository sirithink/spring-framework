...
public abstract class AbstractRefreshableConfigApplicationContext extends AbstractRefreshableApplicationContext
	 ...
	 * <p>
	 * The default implementation returns <code>null</code>. Subclasses can override this to provide a set of resource
	 ...
	 * <p>
	 * The default implementation returns <code>null</code>, requiring explicit config locations.
	...
	/**
	 * Resolve the given path, replacing placeholders with corresponding system property values if necessary. Applied to
	 * config locations.
